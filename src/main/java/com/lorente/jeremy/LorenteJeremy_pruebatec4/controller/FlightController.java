...
import com.lorente.jeremy.LorenteJeremy_pruebatec4.service.IFlightService;
...
public class FlightController {
    ...
    @GetMapping
    public ResponseEntity<?> getAllFlights(@RequestParam(required = false) String origin, @RequestParam(required = false) String destination, @RequestParam(required = false) String dateFrom, @RequestParam(required = false) String dateTo) {
