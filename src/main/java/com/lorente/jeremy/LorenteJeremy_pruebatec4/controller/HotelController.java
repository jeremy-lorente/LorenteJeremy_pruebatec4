...
import com.lorente.jeremy.LorenteJeremy_pruebatec4.service.IHotelService;
...
public class HotelController {
    ...
    public ResponseEntity<?> getAllHotels(
        ...
        if (city != null && dateFrom != null && dateTo != null) {
            ...
            hotels = hotelService.findAvailableHotelsInCityForDates(city, parsedDateFrom, parsedDateTo);
        } else {
